...
```
        ...
        if len(df) > 1:
            ...
            # Build table data
            comparison_data = []
            for idx, item in enumerate(comparison_list[:5], 1):
            ...
            st.caption("🏆 = BEST VALUE (Profit × Tradability) | Qty to Buy = Suggested quantity | Speed = How long to flip | Tradability = How easy to buy/sell")
